...
const {
  ...
  currentAspectList,
  aspectsOption
} = useAspectSelect(spirits, aspects)
const { spiritSelect, closeSpiritSelect, selectSpirit, toggleSpiritSelect } =
  useSpiritSelect(spirits, aspects)
const { randomSetup, startGame, randomSpiritAndMap, canStartGame } =
  useSetupGame(
    spirits,
    islands,
    aspects,
...
<template>
  ...
  >
    <base-button button-style="secondary" class="mb-2" @click="randomSetup">
      Re-Random
    </base-button>
    <button
    ...
    <modal-aspect
      v-if="currentAspectList && currentAspectList.length"
      :aspects="currentAspectList"
