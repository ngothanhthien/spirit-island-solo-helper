...
<template>
  <Listbox v-model="selectedModal" class="inline-block">
    <div class="relative mt-1">
      ...
      >
        <ListboxOptions
          class="z-30 absolute mt-1 max-h-28 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
        >
          <ListboxOption
